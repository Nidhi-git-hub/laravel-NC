                              ...
                              <table id="table_id" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       {
                                       @endphp
                                       <img src="{{url('/uploads/product/'.$product->image)}}" style="height: 150px; width: 150px" >
                                       @php 
                                       } else {
                                       @endphp 
                                       <p>No image found</p>
                                       ...
                                       <td>
                                          <input type="checkbox" class="ProductStatus btn btn-success" rel="{{$product->id}}" data-toggle="toggle" data-on="Enabled" data-of="Disabled" data-onstyle="success" data-offstyle="danger"

                                          @if($product['status']=="1")checked @endif>
                                          <div id="myElem" style="display: none;" class="alert alert-success">Status Enabled</div></td>
                                       <td>
                                          <input type="checkbox" class="FeaturedStatus btn btn-success" rel="{{$product->id}}" data-toggle="toggle" data-on="Enabled" data-of="Disabled" data-onstyle="success" data-offstyle="danger"
